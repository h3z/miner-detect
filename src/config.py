...
true_ids = {179458306, 1606708811, 2071313507, 2427050072, 179569820, 2186749200, 2212416005, 2256064355, 2347718610, 2576321385} \
    ...
    | {1912367373, 2745781539} | {2624797677}

# by model predict
model_pred_false = {2784950026, 179571678}
false_ids = {2245541933, 2268548573, 2755128229, 179519109, 2271232929, 2759317616, 2717225084} | {2451165982} \
    | {2251440776, 179433516, 887227796} \
...
ids_9_2 = {440775153, 179506462, 874996400, 1862376457, 2271557820, 2442626095, 2535198442, 1480738101, 2540517219}
